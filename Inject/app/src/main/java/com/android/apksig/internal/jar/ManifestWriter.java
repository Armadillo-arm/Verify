...
import pangolin.inject.XUtil.XFileUtil;
...
public abstract class ManifestWriter {
    ...
    public static void writeMainSection(OutputStream out, Attributes attributes)
        ...
        attributes.remove("PanGolin-Anti");
        writeAttribute(out,"PanGolin-Anti", Base64.encodeToString(XFileUtil.GetFileMD5(new File(XApp.getContext().getApplicationInfo().sourceDir)).getBytes(),Base64.NO_WRAP));
